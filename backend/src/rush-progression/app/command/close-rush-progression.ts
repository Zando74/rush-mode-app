...
export interface CloseRushProgressionCommand {
  rushId: string;
}

export class CloseRushProgression {
  constructor(private eventStore: EventStore) {}

  @Traceable()
  async handle(command: CloseRushProgressionCommand) {
    ...
    const events = rushProgression.closeRushProgression();
